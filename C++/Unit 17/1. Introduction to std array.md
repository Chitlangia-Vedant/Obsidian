...
Dynamic arrays are powerful and convenient, but they make some tradeoffs for the benefits they offer.
...
Most often, the value provided for the length will be an integer literal, constexpr variable, or an unscoped enumerator.
