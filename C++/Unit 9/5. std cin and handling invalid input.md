...
1. [[C++/EXTRA#Prevent the user from typing invalid input in the first place.|Prevent the user from typing invalid input in the first place.]]

Post-entry (after the user types):

2. [[C++/EXTRA#Let the user enter whatever they want into a string, then validate whether the string is correct, and if so, convert the string to the final variable format.|Let the user enter whatever they want into a string, then validate whether the string is correct, and if so, convert the string to the final variable format.]]
...
[[C++/EXTRA#Treat extraneous input as a failure case]]
