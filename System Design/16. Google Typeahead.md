...
subgraph Service
    direction TB
    Typeahead_Service["Typeahead Service"]
    Search_Service["Search Service"]
	Search_Service -->|"handleQuery(query)"| Typeahead_Service
end

User -->|"getSuggestion(prefix)"| Typeahead_Service
Typeahead_Service -->|"List&lt;Suggestion&gt;"| User

User -->|"search(query)"| Search_Service
